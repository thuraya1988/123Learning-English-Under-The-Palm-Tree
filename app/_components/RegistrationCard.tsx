...
export default function RegistrationCard() {
  ...
  return (
    ...
    >
      <p className="font-cinzel text-[14px] tracking-[0.2em] uppercase text-[var(--gold)] text-center mb-7 flex items-center justify-center gap-2.5">
      ...
      <div className="mt-5">
        <span className="font-cinzel text-[10px] tracking-[0.15em] uppercase text-[var(--brown-mid)] block mb-2.5">
          Choose Your Avatar
        </span>
        <AvatarSelector value={avatar} onChange={setAvatar} />
        <p className="text-[11px] italic text-[var(--brown-mid)] leading-[1.5] text-center opacity-80 mt-2.5">
      ...
      <button type="submit" className="btn-gold w-full mt-4 !rounded-[12px]">
        Start Your Journey
      </button>
    </form>
  );
...
function Field({
  ...
  return (
    <div className="mb-4">
      <label className="font-cinzel text-[10px] tracking-[0.15em] uppercase text-[var(--brown-mid)] block mb-1.5">
        {label}
      </label>
      <input
        type={type}
