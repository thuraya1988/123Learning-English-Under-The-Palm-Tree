...
export const countries: Country[] = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        id: 'tz-sultanate', type: 'historicalExperience',
        title: 'سلطنة زنجبار — حين انتقل البلاط من مسقط',
        description: 'من عام ١٦٩٨ حتى ١٨٥٦ كانت زنجبار جزءاً من إمبراطورية عُمان، حتى نقل السيد سعيد بن سلطان بلاطه الملكي بالكامل من مسقط إلى زنجبار عام ١٨٣٢-١٨٤٠. سلاطين زنجبار كانوا فرعاً من أسرة آل بوسعيد الحاكمة في عُمان نفسها، ولم تنفصل السلطنتان رسمياً إلا بعد وفاته عام ١٨٥٦. لهذا حمل التاجر الزنجباري في روايتنا قناعاً وذاكرةً من موطنٍ واحد. 📚 المرجع: ويكيبيديا — Sultanate of Zanzibar / Omani Empire.',
        teacher: { name: 'السيد سعيد بن سلطان', avatar: 'س', bio: 'نقل بلاطه من مسقط إلى زنجبار' },
        platform: 'custom', streamUrl: 'https://en.wikipedia.org/wiki/Sultanate_of_Zanzibar',
        thumbnail: `${HERITAGE}/heritage-10.jpg`, isLive: false, viewerCount: 0,
        scheduledStart: '2026-01-01T17:00:00Z', language: 'Arabic', ageGroup: 'all',
        topic: 'Stories', level: 'intermediate', tags: ['زنجبار', 'آل بوسعيد', 'سلطنة'],
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        id: 'gb-qaboos', type: 'historicalExperience',
        title: 'قابوس في بريطانيا — من التلمذة إلى النهضة',
        description: 'قبل أن يصبح سلطاناً، أرسل السلطان سعيد بن تيمور ابنه قابوس ليتعلّم في بريطانيا (١٩٥٨-١٩٦٠)، ثم يتدرّب في الكلية الحربية بساندهيرست. تلك السنوات شكّلت رؤيته لاحقاً: فحين تولّى الحكم عام ١٩٧٠ ولم يكن في عُمان كلها سوى ثلاث مدارس، استقدم معلمين بريطانيين لبناء نظامٍ تعليمي جديد — وتأسّست مدرسة بريطانيا مسقط في تلك السنة نفسها بثلاثة تلاميذ ومعلمةٍ واحدة. 📚 المرجع: ويكيبيديا — British School Muscat / Education in Oman.',
        teacher: { name: 'السلطان الشاب', avatar: 'ق', bio: 'تعلّم في بريطانيا قبل أن يبني بلده' },
        platform: 'custom', streamUrl: 'https://en.wikipedia.org/wiki/British_School_Muscat',
        thumbnail: `${HERITAGE}/heritage-29.jpg`, isLive: false, viewerCount: 0,
        scheduledStart: '2026-01-01T17:00:00Z', language: 'Arabic', ageGroup: 'all',
        topic: 'Stories', level: 'intermediate', tags: ['قابوس', 'مدرسة بريطانيا مسقط', 'النهضة'],
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        id: 'tr-ottoman', type: 'historicalExperience',
        title: 'مسقط تحت الراية العثمانية',
        description: 'من عام ١٥٥٢ حتى ١٦٩٨ سيطر العثمانيون على مسقط مرتين، ردّاً على النفوذ البرتغالي في بحر عُمان. وفي القرن الثامن عشر تبادل السلطان العثماني عبد الحميد الأول رسائل مع الإمام أحمد بن سعيد يطلب التنسيق ضد الضغط الفارسي على البصرة — ووثائق الأرشيف العثماني (٣٨٣٨ وثيقة) توثّق ٣٧٠ سنة من العلاقة بين البلدين. علاقةٌ بحريةٌ ودبلوماسية أقدم مما نتخيل. 📚 المرجع: ويكيبيديا — Oman–Turkey relations.',
        teacher: { name: 'الوالي العثماني', avatar: 'ع', bio: 'حكم مسقط باسم الباب العالي' },
        platform: 'custom', streamUrl: 'https://en.wikipedia.org/wiki/Oman%E2%80%93Turkey_relations',
        thumbnail: `${HERITAGE}/heritage-14.jpg`, isLive: false, viewerCount: 0,
        scheduledStart: '2026-01-01T21:00:00Z', language: 'Arabic', ageGroup: 'all',
        topic: 'Stories', level: 'intermediate', tags: ['عثماني', 'مسقط', 'أرشيف'],
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        id: 'bh-invasion', type: 'historicalExperience',
        title: '١٧١٧ — حين أبحر أسطول اليعاربة إلى البحرين',
        description: 'عام ١٧١٧ أبحر أسطول دولة اليعاربة العُمانية إلى البحرين وأنهى الحكم الصفوي الفارسي عليها. وبعد عقود، عام ١٧٩٩، غزاها السيد سلطان بن أحمد مجدداً ونصّب ابنه والياً عليها قبل أن يُطرد الفرع العُماني منها عام ١٨٠٢. تاريخٌ من العلاقات المتشابكة بين الشاطئَين — امتدّ لاحقاً إلى جماعة «البحارنة» الذين استقرّ بعضهم في عُمان. 📚 المرجع: ويكيبيديا — 1717 Omani invasion of Bahrain.',
        teacher: { name: 'قائد اليعاربة', avatar: 'ي', bio: 'أبحر بأسطولٍ إلى البحرين' },
        platform: 'custom', streamUrl: 'https://en.wikipedia.org/wiki/1717_Omani_invasion_of_Bahrain',
        thumbnail: `${HERITAGE}/heritage-19.jpg`, isLive: false, viewerCount: 0,
        scheduledStart: '2026-01-01T20:00:00Z', language: 'Arabic', ageGroup: 'all',
        topic: 'Stories', level: 'intermediate', tags: ['اليعاربة', 'البحرين', 'تاريخ'],
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        id: 'ir-nadershah', type: 'historicalExperience',
        title: 'أحمد بن سعيد — كيف بدأت السلالة الحاكمة؟',
        description: 'بين ١٧٣٧ و١٧٤٣ اجتاح نادر شاه الفارسي الخليج واستغلّ انقساماً داخلياً بين قبائل عُمان ليحتلّ مسقط وصحار. بعد اغتيال نادر شاه عام ١٧٤٧، قاد أحمد بن سعيد — مؤسّس أسرة آل بوسعيد الحاكمة في عُمان حتى اليوم — طرد آخر الحاميات الفارسية واستعاد استقلال البلاد. صراعٌ خارجي وُلدت منه أسرةٌ ما تزال تحكم. 📚 المرجع: ويكيبيديا — Afsharid conquests in the Persian Gulf and Oman.',
        teacher: { name: 'أحمد بن سعيد', avatar: 'أ', bio: 'طرد الفرس وأسّس أسرة آل بوسعيد' },
        platform: 'custom', streamUrl: 'https://en.wikipedia.org/wiki/Afsharid_conquests_in_the_Persian_Gulf_and_Oman',
        thumbnail: `${HERITAGE}/heritage-28.jpg`, isLive: false, viewerCount: 0,
        scheduledStart: '2026-01-01T18:00:00Z', language: 'Arabic', ageGroup: 'all',
        topic: 'Stories', level: 'intermediate', tags: ['آل بوسعيد', 'نادر شاه', 'تاريخ'],
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        id: 'ae-tawam', type: 'historicalExperience',
        title: 'توأم — واحةٌ عاشت بلا حدود',
        description: 'واحة العين والبريمي كانتا تاريخياً منطقةً واحدة تُسمّى «توأم»: تسع قرى تعيش على الأفلاج نفسها، ثلاثٌ منها موالية لسلطان عُمان وستٌّ لشيخ أبوظبي — دون حدودٍ رسمية تفصل بينها لعقود طويلة، حتى تم ترسيم الحدود نهائياً بين ٢٠٠٦ و٢٠٠٨. اليوم تجمع جامعة البريمي طلاباً من الجانبين على الحدود نفسها. 📚 المرجع: ويكيبيديا — Al-Buraimi Oasis / University of Buraimi.',
        teacher: { name: 'شيخ الواحة', avatar: 'ت', bio: 'عاش في قريةٍ بلا حدود' },
        platform: 'custom', streamUrl: 'https://en.wikipedia.org/wiki/Al-Buraimi_Oasis',
        thumbnail: `${HERITAGE}/heritage-20.jpg`, isLive: false, viewerCount: 0,
        scheduledStart: '2026-01-01T19:00:00Z', language: 'Arabic', ageGroup: 'all',
        topic: 'Stories', level: 'intermediate', tags: ['توأم', 'البريمي', 'العين'],
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        id: 'sa-buraimi', type: 'historicalExperience',
        title: 'نزاع البريمي — حكاية حدودٍ ورمال',
        description: 'بين ١٨٠٠ و١٨٦٩ وصلت قوات الدولة السعودية الأولى إلى واحة البريمي واحتلّتها فترات متقطعة، وفي خمسينيات القرن العشرين تجدّد النزاع دبلوماسياً وعسكرياً بين السعودية وعُمان والإمارات على الواحة نفسها، حتى عولجت المسألة في معاهدة جدة عام ١٩٧٤. قصة حدودٍ متنازعٍ عليها تعكس قروناً من التجارة والولاءات القبلية المتشابكة عبر الصحراء. 📚 المرجع: ويكيبيديا — Oman–Saudi Arabia relations / Buraimi dispute.',
        teacher: { name: 'المؤرخ', avatar: 'ب', bio: 'يروي حكاية حدودٍ لم تُرسم بسهولة' },
        platform: 'custom', streamUrl: 'https://en.wikipedia.org/wiki/Oman%E2%80%93Saudi_Arabia_relations',
        thumbnail: `${HERITAGE}/heritage-30.jpg`, isLive: false, viewerCount: 0,
        scheduledStart: '2026-01-01T21:00:00Z', language: 'Arabic', ageGroup: 'all',
        topic: 'Stories', level: 'intermediate', tags: ['البريمي', 'حدود', 'تاريخ'],
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        id: 'iq-jabir', type: 'historicalExperience',
        title: 'جابر بن زيد — من نزوى إلى البصرة',
        description: 'وُلد جابر بن زيد قرب نزوى، ثم سافر إلى البصرة ليتتلمذ على يد صحابة النبي ﷺ مثل ابن عباس وعائشة رضي الله عنها. هناك صار المنظّم الفعلي لمدرسة الفكر الإباضي، وحين ضيّق عليه والي الأمويين الحجّاج، طُرد من البصرة فعاد إلى عُمان حاملاً علمه — ليؤسّس الأساس الفكري للمذهب الإباضي الذي ما يزال سائداً في عُمان اليوم. طالبٌ سافر، وعاد معلّماً. 📚 المرجع: ويكيبيديا — Jabir ibn Zayd / Ibadism.',
        teacher: { name: 'الشيخ جابر', avatar: 'ج', bio: 'حمل علم البصرة إلى نزوى' },
        platform: 'custom', streamUrl: 'https://en.wikipedia.org/wiki/Jabir_ibn_Zayd',
        thumbnail: `${HERITAGE}/heritage-13.jpg`, isLive: false, viewerCount: 0,
        scheduledStart: '2026-01-01T11:00:00Z', language: 'Arabic', ageGroup: 'all',
        topic: 'Stories', level: 'intermediate', tags: ['جابر بن زيد', 'البصرة', 'إباضية'],
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        id: 'eg-teachers', type: 'historicalExperience',
        title: 'المعلمون المصريون — بناة المدرسة العُمانية',
        description: 'حين بدأت النهضة عام ١٩٧٠ ولم يكن في عُمان سوى نحو ٩٠٠ تلميذ في ثلاث مدارس فقط، احتاجت البلاد جيشاً من المعلمين لبناء نظامٍ تعليميٍّ جديد بسرعة. كان المعلمون المصريون أكبر مجموعةٍ عربية وافدة وأكثرها تأثيراً — شكّلوا المناهج وأسلوب الفصل الدراسي في عقدي السبعينيات والثمانينيات، حين كان أكثر من ٩٠٪ من معلمي عُمان وافدين. تماماً كما جاء جون وصوفيا في روايتنا. 📚 المرجع: Oman Observer — Egyptian teachers contribution to education in Oman.',
        teacher: { name: 'الأستاذ المصري', avatar: 'م', bio: 'جاء من مصر ليعلّم قريتنا الإنجليزية' },
        platform: 'custom', streamUrl: 'https://www.omanobserver.om/article/1137497/oman/education/egyptian-teachers-contribution-shaped-the-educational-landscape-in-oman',
        thumbnail: `${HERITAGE}/heritage-31.jpg`, isLive: false, viewerCount: 0,
        scheduledStart: '2026-01-01T12:00:00Z', language: 'Arabic', ageGroup: 'all',
        topic: 'Stories', level: 'intermediate', tags: ['معلمون', 'مصر', 'النهضة', '1970'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      {
        id: 'es-thahabi', type: 'historicalExperience',
        title: 'ابن الذهبي — طبيبٌ عُماني في الأندلس',
        description: 'وُلد ابن الذهبي في صحار، ودرس الطب في البصرة وبلاد فارس، ثم استقرّ في بلنسية بالأندلس حيث ألّف كتاب «الماء» — أول موسوعةٍ طبية في التاريخ مرتّبة أبجدياً، وتوفي هناك نحو عام ١٠٦٤. عالمٌ عُماني حمل علمه عبر ثلاث قارات ليترك بصمته في علم الأندلس الطبي. 📚 المرجع: ويكيبيديا — Ibn al-Thahabi.',
        teacher: { name: 'ابن الذهبي', avatar: 'ط', bio: 'من صحار إلى بلنسية، طبيباً ومؤلفاً' },
        platform: 'custom', streamUrl: 'https://en.wikipedia.org/wiki/Ibn_Al-Thahabi',
        thumbnail: `${HERITAGE}/heritage-06.jpg`, isLive: false, viewerCount: 0,
        scheduledStart: '2026-01-01T14:00:00Z', language: 'Arabic', ageGroup: 'all',
        topic: 'Stories', level: 'intermediate', tags: ['ابن الذهبي', 'صحار', 'بلنسية', 'طب'],
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        id: 'tn-zaytuna', type: 'historicalExperience',
        title: 'الزيتونة وجربة — شبكة العلم الإباضي',
        description: 'عُمان موطن أكبر تجمّعٍ إباضي في العالم، وجزيرة جربة التونسية تضمّ واحدة من أقدم الجاليات الإباضية القليلة المتبقية، إلى جانب جبل نفوسة الليبي ووادي ميزاب الجزائري. جامع الزيتونة في تونس — أحد أعرق مراكز العلم الإسلامي — كان ملتقىً تاريخياً لعلماء هذه الشبكة الإباضية المتناثرة عبر شمال أفريقيا، في تواصلٍ فكري ممتدٍّ مع علماء عُمان. تراثٌ فكري مشترك أكثر منه تبادلاً مباشراً. 📚 المرجع: ويكيبيديا — Al-Zaytuna Mosque / Ibadism.',
        teacher: { name: 'طالبٌ من جربة', avatar: 'ز', bio: 'يشارك عُمان مذهباً واحداً' },
        platform: 'custom', streamUrl: 'https://en.wikipedia.org/wiki/Al-Zaytuna_Mosque',
        thumbnail: `${HERITAGE}/heritage-26.jpg`, isLive: false, viewerCount: 0,
        scheduledStart: '2026-01-01T15:00:00Z', language: 'Arabic', ageGroup: 'all',
        topic: 'Stories', level: 'intermediate', tags: ['الزيتونة', 'إباضية', 'جربة'],
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        id: 'cn-silkroad', type: 'historicalExperience',
        title: 'سفينة سهار — رحلة السندباد الحقيقية إلى الصين',
        description: 'وصلت سفن عُمانية إلى قوانغتشو الصينية منذ عام ٦٧١ ميلادية، وكان ميناء صحار — كما وصفه الجغرافيون القدامى — بوابةً إلى الصين. رحلة الملّاح أبو عبيدة الأسطورية من صحار إلى قوانغتشو في القرن الثامن ارتبطت بحكايات السندباد، وأُعيد تمثيلها فعلياً عام ١٩٨٠-١٩٨١ حين أبحرت سفينة «سهار» المصنوعة يدوياً — بنّاؤون وبحّارة عُمانيون — الطريق نفسه بقيادة الرحّالة تيم سيفرين. 📚 المرجع: اليونسكو (Silk Roads Programme) — Oman: a Hub on the Maritime Trade Routes.',
        teacher: { name: 'الملّاح أبو عبيدة', avatar: 'ب', bio: 'أبحر من صحار إلى قوانغتشو' },
        platform: 'custom', streamUrl: 'https://en.unesco.org/silkroad/content/did-you-know-oman-region-hub-maritime-trade-routes',
        thumbnail: `${HERITAGE}/heritage-11.jpg`, isLive: false, viewerCount: 0,
        scheduledStart: '2026-01-01T16:00:00Z', language: 'Arabic', ageGroup: 'all',
        topic: 'Stories', level: 'intermediate', tags: ['سفينة سهار', 'صحار', 'طريق الحرير البحري'],
      },
    ],
  },
];
