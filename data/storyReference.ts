 ...
 *
 * All chapters, characters, vocabulary, and lessons in this app must be
 * grounded in the story file titled:
 *   "123 Let's Learn English Under the Palm Tree"
 *
 * Where specific story content is not yet linked, components must show:
 *   [Story File Reference Required]
 ...
 *
 * Do NOT invent plot, character details, vocabulary, or chapter content.
 */
