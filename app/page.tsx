  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-[2] grid lg:grid-cols-12 gap-12 items-center max-w-[1200px] w-full">
          <div className="lg:col-span-7">
            <p className="font-cinzel text-[11px] tracking-[0.3em] uppercase text-[var(--gold)] mb-5 flex items-center gap-3">
            ...
            <h1 className="font-cormorant text-[clamp(48px,6vw,80px)] font-light leading-[1.1] text-[var(--brown)] mb-4">
              Learn Under
              <br />
              <em className="italic text-[var(--gold)]">The Palm Tree</em>
            </h1>
            <p className="font-eb italic text-lg text-[var(--brown-mid)] leading-[1.7] mb-8 max-w-[420px]">
              Where language blooms beneath golden fronds,
              <br />
              and every story opens a new world.
            </p>
            <div className="gold-line !mx-0 mb-7" />
            <p className="text-[15px] italic text-[var(--brown-mid)] leading-[1.7] max-w-[380px]">
        ...
        <div className="max-w-[1200px] mx-auto w-full">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {ABOUT_CARDS.map((c) => (
              ...
              >
                <p className="font-cinzel text-[13px] tracking-[0.18em] uppercase text-[var(--gold)] mb-3 flex items-center gap-2.5">
      ...
      <section className="section-beige min-h-screen flex flex-col justify-center py-24 px-6 md:px-12">
        <div className="max-w-[1200px] mx-auto w-full">
          <p className="section-eyebrow">The People of the Village</p>
          <h2 className="section-title">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {CHARACTER_GROUPS.map((g) => (
              ...
              >
                <div
                  className="arch-img"
                  style={{ backgroundImage: `url(${GROUP_IMAGES[g.key]})` }}
                />
                <div className="p-6 text-center">
                  <h3 className="font-cinzel text-[14px] tracking-[0.15em] uppercase text-[var(--brown)] mb-2">
                    The {g.title}
                  </h3>
                  <p className="text-sm italic text-[var(--brown-mid)] mb-4 leading-[1.6]">
                    {g.blurb}
                  </p>
      ...
      <section className="section-lighter min-h-screen flex flex-col justify-center py-24 px-6 md:px-12">
        <div className="max-w-[1200px] mx-auto w-full">
          <p className="section-eyebrow">The Novel</p>
          <h2 className="section-title">
          ...
          <div className="text-center mb-12">
            <Link href="/story" className="btn-gold !px-12">
              Enter The Story
            </Link>
          </div>
      ...
      <section className="section-beige min-h-screen flex flex-col justify-center py-24 px-6 md:px-12">
        <div className="max-w-[1200px] mx-auto w-full">
          <p className="section-eyebrow">Sounds of the Palm</p>
          <h2 className="section-title">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {TRACKS.slice(0, 6).map((t, i) => (
              <Link key={t.id} href="/music" className="music-card glass-deep">
                ...
                <div>
                  <h4 className="font-cinzel text-[13px] tracking-[0.12em] uppercase text-[var(--brown)] mb-1.5">
                    {t.title}
                  </h4>
                  <p className="text-sm italic text-[var(--brown-mid)] leading-[1.5]">
          ...
          <div className="text-center mt-10">
            <Link href="/music" className="btn-outline">View All 22 Tracks</Link>
          </div>
        </div>
      </section>
      ...
      <section className="section-lighter min-h-screen flex flex-col justify-center py-24 px-6 md:px-12">
        <div className="max-w-[1200px] mx-auto w-full">
          <p className="section-eyebrow">Practice &amp; Grow</p>
          <h2 className="section-title">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-5">
            {SKILLS.map((s) => (
              <Link key={s.slug} href={`/skills/${s.slug}`} className="skill-card">
                ...
                <p className="font-cinzel text-[11px] tracking-[0.12em] uppercase text-[var(--brown)] mb-2">
                  {s.title}
                </p>
                <p className="text-xs italic text-[var(--brown-mid)] leading-[1.5] mb-3.5">
                  {s.description}
                </p>
                <span className="skill-btn">Explore</span>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="section-beige min-h-screen flex flex-col justify-center py-24 px-6 md:px-12">
        <div className="max-w-[1200px] mx-auto w-full">
          <p className="section-eyebrow">Play &amp; Learn</p>
          <h2 className="section-title">
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center mb-16">
            <Link href="/games/2026" className="game-era-btn modern glass-deep">
              ...
              <p className="text-[13px] italic text-[var(--brown-mid)] mt-2 leading-[1.5]">
      ...
      <section className="section-lighter py-24 px-6 md:px-12">
        <div className="max-w-[1200px] mx-auto w-full">
          ...
          <div className="text-center">
            <Link href="/gallery" className="btn-outline">Open The Gallery</Link>
          </div>
        </div>
      </section>
      ...
      <section className="section-beige py-24 px-6 md:px-12">
        <div className="max-w-[1200px] mx-auto w-full grid md:grid-cols-2 gap-8">
          ...
          >
            <p className="section-eyebrow !text-center">Immersive</p>
            <h3 className="font-cormorant text-4xl text-[var(--brown)] mb-3 mt-2">
              The <em className="italic text-[var(--gold)]">AR</em> Experience
            </h3>
            <p className="text-base italic text-[var(--brown-mid)] mb-6 leading-[1.7]">
          ...
          <Link
            ...
            className="glass-deep p-10 rounded-[20px] hover:-translate-y-1 transition-transform text-center"
          >
            <p className="section-eyebrow !text-center">Completion</p>
            <h3 className="font-cormorant text-4xl text-[var(--brown)] mb-3 mt-2">
              Your <em className="italic text-[var(--gold)]">Certificate</em>
            </h3>
            <p className="text-base italic text-[var(--brown-mid)] mb-6 leading-[1.7]">
